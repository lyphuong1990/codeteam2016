...
@section('content')
	...
	@endif
	{!! Form::open(array('route' => 'doanhnghiep.store','method'=>'POST')) !!}
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>MST:</strong>
                {!! Form::text('mst', null, array('placeholder' => 'MST','class' => 'form-control','style'=>'height:30px')) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
 ...
 <div class="col-xs-12 col-sm-12 col-md-12">
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::text('user_id', Auth::user()->id, array('placeholder' => 'User id','class' => 'form-control','style'=>'height:30px' )) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>User name:</strong>
                {!! Form::text('user_name', Auth::user()->name, array('placeholder' => 'User name','class' => 'form-control','style'=>'height:30px')) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
